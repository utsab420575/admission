                        ...
                        <div class="widget-summary d-flex align-items-center">
                            ...
                            <div class="widget-summary-col flex-grow-1 d-flex align-items-center" style="padding-left: 100px;">
                                <div class="summary text-center">
                                    ...
                                    <div class="info">
                                        <strong class="amount fs-3">{{$completeEvaluationCount}} / {{ $totalAssigned }}</strong> {{-- Larger count --}}
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="widget-summary d-flex align-items-center">
                            ...
                            <div class="widget-summary-col flex-grow-1 d-flex align-items-center" style="padding-left: 100px;">
                                <div class="summary text-center">
                                    ...
                                    <div class="info">
                                        <strong class="amount fs-3">{{$pendingEvaluationCount}} / {{ $totalAssigned }}</strong> {{-- Larger count --}}
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="widget-summary d-flex align-items-center">
                            ...
                            <div class="widget-summary-col flex-grow-1 d-flex align-items-center" style="padding-left: 100px;">
                                <div class="summary text-center">
                                    ...
                                    <div class="info">
                                        <strong class="amount fs-3">{{$disputeEvaluationCount}} / {{ $totalAssigned }}</strong> {{-- Larger count --}}
                                    </div>
                                </div>
                            </div>
                        </div>
